    ...
    return (
        <div className='bg-gray-100 border-b-2 border-blue-400 h-10 flex justify-between px-4 items-center  ' >
            ...
            <div className="flex gap-4 items-center ">
                <p className="cursor-pointer capitalize " > {user?.userName ? <div className="flex items-center gap-1 text-xl hover:text-blue-600  " > <FaUser />{user.userName} </div> :
                    <button className="cursor-pointer  rounded text-blue-500 font-bold " onClick={() => navigate("/login")} >Login</button>}</p>
